  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <div className="max-w-4xl w-full p-2">
        <h1 className="text-lg sm:text-3xl font-bold text-left mb-6 text-purple-600">Privacy Policy</h1>

        <h2 className="text-md sm:text-xl font-semibold text-gray-800 mb-4">Who We Are</h2>
        ...
        <h2 className="text-md sm:text-xl font-semibold text-gray-800 mb-4">What Data We Collect and Why</h2>

        <h3 className="text-md sm:text-lg font-semibold text-gray-800 mb-2">Comments</h3>
        ...
        <h3 className="text-md sm:text-lg font-semibold text-gray-800 mb-2">Media</h3>
        <p className="text-sm sm:text-lg text-gray-700 mb-4">
        ...
        <h3 className="text-md sm:text-lg font-semibold text-gray-800 mb-2">Cookies</h3>
        <p className="text-sm sm:text-lg text-gray-700 mb-4">
        ...
        <h3 className="text-md sm:text-xl font-semibold text-gray-800 mb-2">Embedded Content from Other Websites</h3>
        <p className="text-sm sm:text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-md sm:text-xl font-semibold text-gray-800 mb-4">Who We Share Your Data With</h2>
        <p className="text-sm sm:text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-md sm:text-xl font-semibold text-gray-800 mb-4">Data Retention</h2>
        <p className="text-sm sm:text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-md sm:text-xl font-semibold text-gray-800 mb-4">Your Rights Over Your Data</h2>
        <p className="text-sm sm:text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-md sm:text-xl font-semibold text-gray-800 mb-4">Where Your Data is Sent</h2>
        <p className="text-sm sm:text-lg text-gray-700 mb-6">
