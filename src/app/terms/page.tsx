  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="max-w-4xl w-full p-2">
        <h1 className="text-4xl font-bold text-left mb-6 text-purple-600">Terms of Service</h1>

        <h2 className="text-2xl font-semibold text-gray-800 mb-4">1. General Disclaimer</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">2. No Guarantee or Warranty</h2>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">5. Termination of Services</h2>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">6. Beware of Fraud and Scams</h2>
        <p className="text-lg text-gray-700 mb-6">
