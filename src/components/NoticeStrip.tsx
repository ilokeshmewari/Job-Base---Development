...
const NoticeStrip = () => {
  return (
    <div className="w-full bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 text-white py-2 overflow-hidden">
      ...
      Sorry for any inconvenience caused. Our goal is to provide you with the best possible experience on this platform. We're currently working on improvements and have removed ads that may have disrupted your experience. Thank you for your patience and understanding.
      </div>
    </div>
  );
};
