...
export default function Auth() {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (captchaInput !== captcha) {
      setMessage({ text: 'CAPTCHA code is incorrect', type: 'error' });
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      setMessage({
        text: 'Signup successful! Please confirm your email before logging in.',
        type: 'success',
      });
      setShowSignUp(false);
      setEmail('');
        ...
        {showSignUp ? (
          <form onSubmit={handleSignUp} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <div className="bg-purple-100 text-purple-700 font-mono font-bold text-lg px-4 py-2 rounded-md select-none w-1/2 text-center">
                  {captcha}
                </div>
                <input
                  type="text"
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <button type="button" onClick={() => setShowSignUp(true)} className="text-blue-600 hover:text-blue-800 font-medium">
                Sign up
              </button>
            </div>
          </form>
